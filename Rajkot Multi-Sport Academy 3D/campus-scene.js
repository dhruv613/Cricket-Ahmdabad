(function () {
  ...
  const entry=new URL('../campus/entry.js?v=15',source).href;
  if(!document.querySelector('link[data-campus-style]')){const style=document.createElement('link');style.rel='stylesheet';style.href=new URL('../campus/scene.css?v=15',source).href;style.dataset.campusStyle='';document.head.append(style);}
